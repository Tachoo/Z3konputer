    ...
    <table class="contenedor">
        ...
        <tr class="main">
            <td class="linked-section">
                ...
                <p>Tu Cuenta esta Casi Lista</p>
                <p>Para confimar tu Cuenta, Haz click en el siguiente boton:</p>
            </td>
            <td class="linked-section">
                <a class="a-btn-mail" href="<?php echo $_ENV['Project_URL']."/confirmar-cuenta?token=".$this->token; ?>">Confima tu cuenta</a>
            </td>
            <td class="linked-section">
                <p>Si no funciona el boton puedes copiar el siguiente enlace: <a href="<?php echo $_ENV['Project_URL']."/confirmar-cuenta?token=".$this->token; ?>"><?php echo $_ENV['Project_URL']."/confirmar-cuenta?token=".$this->token; ?></a> y pegarlo en tu navegador</p>
            </td>
        </tr>
